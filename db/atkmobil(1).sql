...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2021 at 06:41 PM
...
CREATE TRIGGER `TG_MOBIL_KELUAR` AFTER INSERT ON `tb_mobil_keluar` FOR EACH ROW BEGIN
 ...
 WHERE plat_mobil=NEW.plat_mobil;
...
CREATE TRIGGER `TG_PENGEMBALIAN_MOBIL` AFTER UPDATE ON `tb_mobil_keluar` FOR EACH ROW BEGIN
 ...
 WHERE plat_mobil=OLD.plat_mobil;
...
(000001, '2016', 'D 1079 B', 'Toyota Avanza 1.5 Veloz A/T', 'Minibus', '3', 'Kendaraan Operasional Pool Kendaraan'),
(000002, '2013', 'D 1479 E', 'Toyota Rush 1.5S S M/T TRD', 'Minibus', '1', 'Kendaraan Operasional Pool Kendaraan'),
(000003, '2009', 'D 1394 F', 'Toyota Kijang Inova G', 'Minibus', '3', 'Kendaraan Operasional Pool Kendaraan'),
...
--
ALTER TABLE `tb_mobil_keluar`
  MODIFY `id` int(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
