      ...
      <div class="container-fluid">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-archive" aria-hidden="true"></i> Ubah Data Satuan Barang</h3>
              </div>
              <!--card-body -->
              <div class="card-body">
                ...
                <?php endif; ?>
                <!-- form start -->
                <form method="post" action="<?= base_url('admin/proses_satuan_update/' . $list_satuan['id_satuan']) ?>">
                  <div class="card-body">
                    <!-- row 1 -->
                    <div class="row" style="margin-left:30%">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="kode_satuan" name="kode_satuan" placeholder="Pcs" value="<?= $list_satuan['kode_satuan']; ?>">
                        </div>
                      </div>
                      <!-- /.col 1 -->
                      <!-- col 2 -->
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="nama_satuan" name="nama_satuan" placeholder="Pieces" value="<?= $list_satuan['nama_satuan']; ?>">
                        </div>
                      </div>
                      <!-- /.col 2 -->
                      <!-- col 3 -->
