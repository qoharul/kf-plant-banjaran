  ...
  <div class="container-fluid">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title"><i class="fa fa-archive" aria-hidden="true"></i> Tambah Data Barang Masuk</h3>
      </div>
      <!-- card-body -->
      <div class="card-body">
          ...
          <div class="row" style="margin-left:8%">
            ...
            <div class="col">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="kode_barang" name="kode_barang" placeholder="036000291452">
              </div>
            </div>
            <!-- /.col 1 -->
            <!-- col 2 -->
            <div class="col-md-auto">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_barang" name="nama_barang" placeholder="Kertas A4">
              </div>
            </div>
            <!-- /.col 2 -->
            <!-- col 3 -->
            <div class="col">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="satuan" name="satuan" placeholder="Rim">
              </div>
            </div>
            <!-- /.col 3 -->
            <!-- col 4 -->
